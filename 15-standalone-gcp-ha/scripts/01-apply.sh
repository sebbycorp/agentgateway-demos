...
license_is_set || die "set TF_VAR_agentgateway_license_key or ENTERPRISE_AGENTGATEWAY_LICENSE_KEY (do not commit it)"

export TF_VAR_agentgateway_license_key="${TF_VAR_agentgateway_license_key:-${ENTERPRISE_AGENTGATEWAY_LICENSE_KEY:-${AGENTGATEWAY_LICENSE_KEY:-}}}"
