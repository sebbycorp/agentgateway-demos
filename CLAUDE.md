...
| deploy (Render image pack) | (standalone Docker on Render; no kind) | v1.5.0 |
| 34-render-deploy-agw | (Render how-to; builds `deploy/`) | v1.5.0 |
