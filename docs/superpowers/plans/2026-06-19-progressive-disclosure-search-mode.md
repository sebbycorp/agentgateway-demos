...
**Goal:** Build a self-contained AgentGateway Enterprise demo (`102-ent-tokenomics/`) that deploys MCP search mode and produces hard A/B data proving search mode cuts prompt tokens and cost versus default mode, visualized in a simple Grafana dashboard.
...
- All work lives under `102-ent-tokenomics/`. Run commands from that directory unless noted.
...
**Files:**
- Create: `102-ent-tokenomics/mcp-server/server.py`
- Create: `102-ent-tokenomics/mcp-server/requirements.txt`
- Create: `102-ent-tokenomics/mcp-server/Dockerfile`
...
Run:
```bash
cd 102-ent-tokenomics/mcp-server
...
git add 102-ent-tokenomics/mcp-server
...
**Files:**
- Create: `102-ent-tokenomics/deploy.sh`
- Create: `102-ent-tokenomics/.env.example`
...
```bash
cd "$(git rev-parse --show-toplevel)"
git add 102-ent-tokenomics/deploy.sh 102-ent-tokenomics/.env.example
...
**Files:**
- Modify: `102-ent-tokenomics/deploy.sh` (append Part B before the `# --- Parts ...` marker comment)
...
```bash
cd "$(git rev-parse --show-toplevel)"
git add 102-ent-tokenomics/deploy.sh
...
**Files:**
- Create: `102-ent-tokenomics/k8s/openai.yaml`
- Modify: `102-ent-tokenomics/deploy.sh` (append Part C)
...
```bash
cd 102-ent-tokenomics && ./deploy.sh
...
```bash
cd "$(git rev-parse --show-toplevel)"
git add 102-ent-tokenomics/k8s/openai.yaml 102-ent-tokenomics/deploy.sh
...
**Files:**
- Create: `102-ent-tokenomics/harness/run_ab.py`
- Create: `102-ent-tokenomics/harness/pricing.json`
- Create: `102-ent-tokenomics/harness/requirements.txt`
...
```bash
cd "$(git rev-parse --show-toplevel)"
git add 102-ent-tokenomics/harness
...
**Files:**
- Create: `102-ent-tokenomics/observability/prometheus-values.yaml`
- Create: `102-ent-tokenomics/observability/grafana-values.yaml`
- Create: `102-ent-tokenomics/observability/dashboard.json`
- Modify: `102-ent-tokenomics/deploy.sh` (append Part D)
...
```bash
cd "$(git rev-parse --show-toplevel)"
git add 102-ent-tokenomics/observability 102-ent-tokenomics/deploy.sh
...
**Files:**
- Create: `102-ent-tokenomics/test.sh`
- Create: `102-ent-tokenomics/cleanup.sh`
- Create: `102-ent-tokenomics/step-by-step.sh`
...
```bash
cd "$(git rev-parse --show-toplevel)"
git add 102-ent-tokenomics/test.sh 102-ent-tokenomics/cleanup.sh 102-ent-tokenomics/step-by-step.sh
...
**Files:**
- Create: `102-ent-tokenomics/README.md`
...
```bash
cd "$(git rev-parse --show-toplevel)"
git add 102-ent-tokenomics/README.md
...
**Files:**
- Modify: `102-ent-tokenomics/deploy.sh` (optional Part E)
- Modify: `102-ent-tokenomics/observability/prometheus-values.yaml`
...
```bash
cd "$(git rev-parse --show-toplevel)"
git add 102-ent-tokenomics/observability/prometheus-values.yaml 102-ent-tokenomics/deploy.sh
